...
<%@ page import="kopo.poly.auth.JwtTokenProvider" %>
...
//공지글 정보를 못불러왔다면, 객체 생성
    ...
    // JWT 토큰으로부터 가져온 아이디 값
    String token_user_id = CmmUtil.nvl((String) request.getAttribute("token_user_id"));
//본인이 작성한 글만 수정 가능하도록 하기(1:작성자 아님 / 2: 본인이 작성한 글 / 3: 로그인안함)
    int edit = 1;
//로그인 안했다면....
    if (token_user_id.equals("")) {
        edit = 3;
//본인이 작성한 글이면 2가 되도록 변경
    } else if (token_user_id.equals(CmmUtil.nvl(rDTO.getUserId()))) {
        edit = 2;
    }
    System.out.println("user_id : " + CmmUtil.nvl(rDTO.getUserId()));
    System.out.println("ss_user_id : " + token_user_id);
%>
<!DOCTYPE html>
<html lang="en">
<head>
